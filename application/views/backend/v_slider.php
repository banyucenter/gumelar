...
<section class="content">
  ...
  <div class="row">
    ...
    <h2> DATA SLIDER </h2>
    <a href="<?php echo base_url(). 'slider/tambah/';?>"><button class="btn btn-warning">Tambah Slider</button></a>
  <hr>
    <thead>
      <tr>
        <th>No</th>
  ...
  <tr>
    ...
    <td>
      <a href="<?php echo base_url(). 'slider/edit/'.$s->id; ?>"><button class="btn btn-primary">Edit</button></a>
      <a href="<?php echo base_url(). 'slider/hapus/'.$s->id; ?>"><button class="btn btn-danger">Hapus</button></a>
    </td>
  </tr>
  <?php } ?>
    </tbody>
