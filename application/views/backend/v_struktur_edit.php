...
<section class="content">
  ...
  <div class="row">
    ...
    <form action="<?php echo base_url(). 'administrator/strukturorganisasi/update'; ?> " method="post" id="form-satuan" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" class="form-control" value="<?php echo $s->id;?>">
        ...
        <tr>
            <td>Alamat</td>
            <td><input type="text" class="form-control" name="alamat" required="required" value="<?php echo $s->no_telp ?>"></td>
        </tr>
            <td></td>
